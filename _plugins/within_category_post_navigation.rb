    ...
    def generate(site)
      site.categories.each_pair do |category, posts|
        ...
        posts.each do |post|
          ...
          if post.data["categories"] == ["somparella"]
            post.data["next_in_category"] = previous_in_category unless previous_in_category.nil?
            post.data["previous_in_category"] = next_in_category unless next_in_category.nil?
          else
